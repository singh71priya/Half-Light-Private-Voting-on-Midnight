...
(function (ElectionStatus) {
  ElectionStatus[ElectionStatus['CREATED'] = 0] = 'CREATED';
  ElectionStatus[ElectionStatus['OPEN'] = 1] = 'OPEN';
...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    this.impureCircuits = {
      openElection: this.circuits.openElection,
  ...
  initialState(...args_0) {
    ...
    state_0.setOperation('openElection', new __compactRuntime.ContractOperation());
                                      ...
                                      [
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_9.toValue(1n),
                                                                                              alignment: _descriptor_9.alignment() }).encode() } },
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_0.toValue(metaHash_0),
                                                                                              alignment: _descriptor_0.alignment() }).encode() } },
                                       { ins: { cached: false, n: 1 } }]);
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
  ...
  _openElection_0(context, partialProofData, adminSk_0) {
    __compactRuntime.assert(this._equal_0(this._persistentHash_0(adminSk_0),
                                          _descriptor_0.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                                    ...
                                                                                                    [
                                                                                                     ...
                                                                                                     { popeq: { cached: false,
                                                                                                                result: undefined } }]).value)),
                            'Only the admin may open this election');
    __compactRuntime.assert(_descriptor_2.fromValue(__compactRuntime.queryLedgerState(context,
                            ...
                            ===
                            0,
                            'Election has already been opened');
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
                                       { push: { storage: false,
    ...
    __compactRuntime.assert(this._equal_1(this._persistentHash_0(adminSk_0),
                                          _descriptor_0.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                                    ...
                                                                                                    [
                                                                                                     ...
                                                                                                     { popeq: { cached: false,
                                                                                                                result: undefined } }]).value)),
                            'Only the admin may close this election');
    __compactRuntime.assert(_descriptor_2.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                      partialProofData,
                                                                                      [
                                                                                       { dup: { n: 0 } },
                            ...
                            ===
                            1,
                            'Election is not currently open');
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
                                       { push: { storage: false,
